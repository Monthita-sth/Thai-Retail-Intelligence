...
## Project Overview
โปรเจกต์นี้เป็นระบบ **End-to-End Data Analytics** ที่จำลองข้อมูลธุรกิจค้าปลีกและ E-Commerce ในประเทศไทย โดยดึงข้อมูลจากไฟล์ข้อมูลดิบมาผ่านกระบวนการทำความสะอาด จัดโครงสร้างฐานข้อมูล วิเคราะห์พฤติกรรมลูกค้า และใช้ Machine Learning (Deep Learning) ในการพยากรณ์ยอดขายล่วงหน้า เพื่อนำเสนอผ่าน Interactive Dashboard ที่ตอบโจทย์การตัดสินใจทางธุรกิจ

***🛠️ Core Tech Stack:** Python, Pandas, SQLite, SQL, TensorFlow, Power BI, Git*

## Business Questions Answered
- ยอดขาย กำไร และอัตรากำไร (Margin) เติบโตไปในทิศทางใด?
- สินค้าใดคือสินค้าทำเงินและสินค้าใดที่กำลังเป็นภาระ?
...
- สินค้าใดอยู่ในสภาวะสต็อกวิกฤต ที่ต้องการการสั่งซื้อด่วน?
...
6. **Data Visualization:** นำข้อมูลทั้งหมดมาผูก Data Model และเขียนสูตร **DAX** สร้าง Dashboard 3 หน้าผ่าน **Power BI**
...
## Dashboard Previews
Click Link Dashboard : [Thai Retail Intelligence](https://app.powerbi.com/view?r=eyJrIjoiZTgyMGQ2ZWEtNzJkYi00OTM0LWE0NzItNzg4MTEyNTU0YjAzIiwidCI6IjhlNjM0ZTY3LTlkNjYtNDZkMi1hNTI5LWUxYjcwOGM1ZDhiYyIsImMiOjEwfQ%3D%3D)
...
### 2. Product Performance & Campaign ROI
วิเคราะห์เจาะลึกสินค้าทำเงินและประเมินประสิทธิภาพของแคมเปญโปรโมชัน
![Product Performance](images/dashboard2.png)

### 3. AI Forecast & Smart Stock
พยากรณ์ยอดขายล่วงหน้า 30 วันด้วยโมเดล LSTM (TensorFlow) และระบบแจ้งเตือนการสั่งสินค้าคงคลัง
![AI Forecast](images/dashboard3.png)

### 📫 Connect: Monthita Songthong
